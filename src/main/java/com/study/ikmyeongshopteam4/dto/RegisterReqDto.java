...
public class RegisterReqDto {
    ...
    @Size(min = 1, max = 3, message = "이름은 3자까지만 입력가능합니다.", groups = ValidationGroups.SizeGroup.class)
    ...
    @Size(min = 1, max = 2, message = "성은 2자까지만 입력가능합니다", groups = ValidationGroups.SizeGroup.class)
    @Pattern(regexp = "^[가-힇]*$", message = "한글만 입력 가능합니다", groups = ValidationGroups.PatternCheckGroup.class)
